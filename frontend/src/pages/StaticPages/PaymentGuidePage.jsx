...
export default function PaymentGuidePage() {
  const paymentMethods = [
    ...
    { icon: Landmark, name: 'Chuyển khoản ngân hàng trực tiếp', desc: 'Chuyển tiền vào tài khoản LaptopDevice bằng cách quét mã QR ngân hàng hoặc nhập thông tin STK thủ công.' },
    ...
    <StaticLayout title="Hướng dẫn thanh toán">
      <div className="space-y-6">
        <p className="text-slate-500 text-sm leading-relaxed">
          LaptopDevice hỗ trợ quý khách hàng đa dạng phương thức thanh toán an toàn, bảo mật và linh hoạt. Quý khách vui lòng tham khảo chi tiết bên dưới.
        </p>
        ...
        <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-blue-800 flex gap-2 items-center">
          ...
          <span>Mọi giao dịch thanh toán tại LaptopDevice đều được mã hóa SSL/TLS bảo mật tuyệt đối 100%.</span>
        </div>
      </div>
    </StaticLayout>
  )
